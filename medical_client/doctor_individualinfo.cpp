    ...
    ui(new Ui::doctor_individualinfo)
{
    ...
    connect(socket, &QTcpSocket::readyRead, this, [this](){
        ...
        if(msg.messageType == MessageType::RET_DOCTOR_PROFILE)
        {
            ...
            QString name = (parts.size() > 0) ? parts[0] : "";
            QString gender = (parts.size() > 1) ? parts[1] : "";
            QString age = (parts.size() > 2) ? parts[2] : "";
            QString phone_number = (parts.size() > 3) ? parts[3] : "";
            QString department = (parts.size() > 4) ? parts[4] : "";
