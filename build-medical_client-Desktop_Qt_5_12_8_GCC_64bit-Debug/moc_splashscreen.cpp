...
#include "../medical_client/splashscreen.h"
...
QT_MOC_LITERAL(3, 23, 19), // "onAnimationFinished"
QT_MOC_LITERAL(4, 43, 14) // "updateProgress"

    },
    "SplashScreen\0finished\0\0onAnimationFinished\0"
    "updateProgress"
};
...
void SplashScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SplashScreen::finished)) {
                *result = 0;
                return;
            }
        }
